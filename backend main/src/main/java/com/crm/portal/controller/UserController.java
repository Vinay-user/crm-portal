...
/**
 * User administration. Restricted to ADMIN/MANAGER at the security-filter
 * level (see SecurityConfig) - RBAC is enforced on the backend regardless
 * of what the frontend chooses to show or hide.
 */
@RestController
