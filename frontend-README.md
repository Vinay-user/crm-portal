...
│   teams, settings
└── utils/constants.js          ROLES, DEAL_STAGES, LEAD_STATUSES,
                                 TASK_STATUSES, PRIORITIES, STORAGE_KEYS
                                 - must stay in sync with the backend's
                                 Java enums (com.crm.portal.enums.*)
```
